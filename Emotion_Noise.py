...
def print_sound(indata, outdata, frames, time, status):
    ...
    global noise
    noise = int(volume_norm)
    #print(noise)
    #print(emotion)
    #if volume_norm > 10 and emotion=="Angry":
    #    print('Loud & Angry')
    return noise
...
if __name__ == '__main__':
    ...
    while True:
        camera = cv2.VideoCapture(0) # If you are using a USB Camera then use 1 instead of 0.
        emotionVideo(camera)
        print(emotion)
